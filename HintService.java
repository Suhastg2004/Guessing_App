...
class HintService {
    ...
    public static String generateHint(int target, int hintCount) {
        if (hintCount == 1){
            return (target % 2 == 0) ? "Hint : Target is Even" : "Hint : Target is Odd";
        }
        else if (hintCount == 2){ // 2nd hint -> Increasing difficulty
            return (target > 50) ? "Hint : Target is greater than 50" : "Hint : Target is 50 or less";
        }
